...
void setup()
{
 ...
 uint8_t node_device_eui[8] = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x9C, 0xE0};
 // OTAA Application Key MSB  
 uint8_t node_app_eui[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
 uint8_t node_app_key[16] = {0xCD, 0x88, 0x25, 0x6E, 0x47, 0x7F, 0xF7, 0x73, 0xBD, 0x32, 0x00, 0x73, 0x2A, 0x17, 0x49, 0x94};
...
char ble_name[12] = { 'L', 'O', 'R', 'A', '-', 'A', 'P', 'O', 'L', 'L', 'O', '\0' };
uint8_t device_name_length = 12;
...
void button_ISR()
{
  ...
  if (buttonFlag > 3) {
    buttonFlag = 0;
    rain_count = rain_count -1; // remove the first count
    // Start BLE UART advertisement for 30 seconds
    api.ble.advertise.start(30);     
  } 
