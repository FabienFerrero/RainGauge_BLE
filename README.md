...
- You can change the format of the data to be able to observe changes, copy text on [TTN_formatters.txt](https://github.com/FabienFerrero/RainGauge_BLE/blob/main/TTN_fomatters.txt), paste as below and save changes : 
